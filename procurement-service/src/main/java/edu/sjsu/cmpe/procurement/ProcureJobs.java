...
public ArrayList<String> HttpGET() throws JSONException {
	...
	Client client = Client.create();
	WebResource webResource = client.resource("http://54.215.210.214:9000/orders/70742");
...
public void Publisher(ArrayList<String> arrivedBooks) throws JMSException{
	...
	int port = 61613;
	String destination1 = "/topic/70742.book.all";
	String destination2 = "/topic/70742.book.computer";
